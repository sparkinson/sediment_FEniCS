...
fname = 'phi_ic_2.json'
file = open(fname,'r')
phi_ic = array(json.loads(file.readline()))
file.close()

fname = 'deposit_data_2_init.json'
file = open(fname,'r')
deposit = array(json.loads(file.readline()))
file.close()

fname = 'deposit_data_2.json'
file = open(fname,'r')
...
ax.plot(linspace(0,0.5,len(phi_ic_target)),phi_ic_target,'k--')
ax.plot(linspace(0,0.5,len(phi_ic)),phi_ic,'b-')
...
ax.plot(linspace(0,14.705646497415245,len(deposit)),deposit,'k--')
ax.plot(linspace(0,12.966874985393511,len(deposit_2)),deposit_2,'b-')
