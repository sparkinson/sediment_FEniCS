...
_sage_const_2p3 = RealNumber('2.3'); _sage_const_2 = Integer(2); _sage_const_2p0 = RealNumber('2.0'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_1p2 = RealNumber('1.2'); _sage_const_1p = RealNumber('1.'); _sage_const_1p4 = RealNumber('1.4'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_1en1 = RealNumber('1e-1'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_10p0 = RealNumber('10.0')
