...
_sage_const_2p3 = RealNumber('2.3'); _sage_const_2 = Integer(2); _sage_const_2p0 = RealNumber('2.0'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_1p2 = RealNumber('1.2'); _sage_const_1p4 = RealNumber('1.4'); _sage_const_0p0 = RealNumber('0.0'); _sage_const_0p5 = RealNumber('0.5'); _sage_const_10p0 = RealNumber('10.0')
...
q = function(phi_n**_sage_const_0p5 *h_n, _sage_const_1p2 , _sage_const_1p0 , _sage_const_0p0 , _sage_const_1p0 )
...
s_q = x*u_N*diff(q,x) - diff(q**_sage_const_2 /h + _sage_const_0p5 *(phi*h), x) + diff(alpha * diff(q/h, x), x)
